//: ## Fill in the Blanks
//: Combining strings by adding them together can work well. You may have noticed, however, that you needed to remember to add spaces between the strings. Otherwise the words all run together:
