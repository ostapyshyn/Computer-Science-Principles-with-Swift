/*:
 ...
 You’ve learned that the results sidebar is not available unless you’re in a playground, so `print` and the console can be the best way to find out what’s happening when you’re building an app.
 
 And just in time, too. In the next lesson, you’ll get started making your first app.
