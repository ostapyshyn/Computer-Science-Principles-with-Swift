...
Did this change make the code hard to read? No problem: These are _your_ preferences, and you can make your code look however you’d like. But if you can still read the code with this dark background, stick with it. In the next few playground pages, you’ll be adding some other old-fashioned effects.
