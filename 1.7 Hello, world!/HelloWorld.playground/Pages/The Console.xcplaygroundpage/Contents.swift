...
/*:
 Even though the code above ran just fine, you’ve received no feedback. The console is empty because it only displays messages when a programmer gives the instruction to print.
