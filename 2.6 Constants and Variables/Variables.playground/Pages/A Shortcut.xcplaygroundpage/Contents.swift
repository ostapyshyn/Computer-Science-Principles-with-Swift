...
score = score + 2
/*:
 This type of operation happens often enough that Swift has a special operator `+=`. This shorthand combines addition (`+`) and assignment (`=`) into one combined operation.
