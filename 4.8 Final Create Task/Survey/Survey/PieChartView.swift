...
public struct PieWedge {
    ...
    public init(proportion: Double, color: UIColor) {
        self.init(proportion: proportion, color: color, scale: 1, offset: 0)
    }

    public init(proportion: Double, color: UIColor, scale: Double, offset: Double) {
...
extension UIColor {
    var suggestedContrastingTextColor: UIColor {
        get {
        ...
        didSet {
            for (index, wedge) in wedges.enumerated() {
                ...
                case .exterior:
                    ...
                    label.textColor = self.backgroundColor?.suggestedContrastingTextColor ?? .black
                case .interior:
                    label.isHidden = false
                    label.textColor = wedge.color.suggestedContrastingTextColor
                }
            }
            self.setNeedsLayout()
        }
    ...
    public var wedges: [PieWedge] = [] {
        didSet {
            ...
            for wedge in wedges {
                ...
                labelLayer.textColor = wedge.color.suggestedContrastingTextColor
