/*:
 ...
 You can set the maximum and minimum values of the X and Y axes using the two functions below. Note that these axes will not be displayed at the same scale.
